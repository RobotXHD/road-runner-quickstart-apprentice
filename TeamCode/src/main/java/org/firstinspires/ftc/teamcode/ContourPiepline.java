...
public class ContourPiepline extends OpenCvPipeline {
    ...
    public ContourPiepline(double borderLeftX, double borderRightX, double borderTopY, double borderBottomY) {
